...
namespace Moq.Typed.Tests.Unit
{
    ...
    internal sealed class TypedMockSetupFor_ITestable
    {
        ...
        public class MethodSetup
        {
            ...
            public MethodSetup Throws(MethodExceptionFunction<TException> exceptionFunction)
            {
        ...
        public class MethodSetup1
        {
            ...
            public MethodSetup1 Throws(MethodExceptionFunction1<TException> exceptionFunction)
            {
